...
<script type="text/javascript">
	function editCategory(id){
		$.get('../ManageCategoryController?flag=edit',{id:id},function(response){
			...
			<div class="row">
				...
				<div class="col-md-6">
					<ul class="list-page-breadcrumb">
						...
						<li class="active-page"><a href="category.jsp">Add
				...
				<div class="widget-wrap">
					...
					<div class="widget-container margin-top-0 clearfix">
						<div class="widget-content">
							<form action="../ManageCategoryController" method="post"
							...
							<table class="table table-striped data-tbl">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<%
												if (category.getStatus().equals("A")) {
