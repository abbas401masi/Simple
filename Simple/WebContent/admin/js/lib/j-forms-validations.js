$(document).ready(function() {
	...
	// Show password
    $("#show-old-pass").on("change", function(){
        $("#show-old-pass").is(":checked") ? $("#oldpassword").attr("type", "text") : $("#oldpassword").attr("type", "password");
    });
    // Show password
...
/////////////////////////////////////////////////////////////////
    ...
    form.validate({
        ...
        messages: {
            ...
            oldpassword: {
            	required: 'Please Old password is required'
            },
            password: {
